...
// export function SendEmail({isOpen, onClick, task}){
//     // new ideas

//     const [sendEmailModalOpen, setEmailModalOpen] = useState(false);

//     const handleToggleEmail = () =>{
//         setEmailModalOpen(!sendEmailOpen);
//     };

//     const handleEmailModalOpen = (task) => {
//         setEmailModalOpen(!sendEmailOpen);
//         console.tag(task)
//     }
...
export function TaskItem({task, handleRemoveTask, item}) {
  ...
  return (
    ...
    <div className="bg-gray-50 border border-gray-300 rounded-lg p-4 mb-4">
        ...
        {sendEmailModalOpen && <SendEmailModal isOpen={sendEmailModalOpen} onClose={closeEmailModal} item = {task}/>}
